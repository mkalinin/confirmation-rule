...
\newcommand{\varforvalattime}[2][]{%
    ...
    \ensuremath{%
        ...
        {}}%
        {{#2}_{\varforvalattime@Val}}
        {{#2}_{\varforvalattime@Val}^{\varforvalattime@Time}}}%
        \setkeys{varforvalattime}{time=,val=}%
}%
...
\newcommand{\highestLMDConfirmedDesc}{\text{highestLMDConfirmedDesc}}
\newcommand{\isOneConfirmed}{\text{isOneConfirmed}}
\newcommand{\isLMDConfirmed}{\text{isLMDConfirmed}}
\newcommand{\willChkpBeJustified}{\text{willChkpBeJustified}}
