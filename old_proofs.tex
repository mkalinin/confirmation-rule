    ...
    \begin{align*}
        ...
        \begin{aligned}[t]
            ...
            \frac
                ...
                {\commweightfromblock[from=b,to=s'-1,chkp={C'}]{\allvals}}
        \end{aligned}
        &&\alignexpl[\alignexplwidth]{By definition. \RS{Issue in this proof step as $\attsetweightfromblock[from=b,to=s-1,val=v,when=\slotstart(s),chkp={C'}]{\slashvals}\leq\attsetweightfromblock[from=b,to=s-1,val=v,when=\slotstart(s),chkp={C}]{\slashvals}$ }}
        \\
        &>
        \begin{aligned}[t]
            &\frac
