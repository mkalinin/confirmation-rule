...
\begin{lemma}[Analogous of Lemma 2 in the paper]\label{lem:condition-on-h-for-canonical}
...
%             +\boostweight[chkp=C]
%             }
%             {2\left((1-\beta)\commweightfromblock[from=b',to=s,chkp=C]{\allvals}-\attsetweighttobediscfromblock[from=b',to=s,val=v,when=t,chkp=C]{\honatts}\right)}
%     \end{aligned}
%     $$    
%     then,
%     $$\forall b' \preceq b,\;
...
%     %             +\boostweight[chkp=C]
%     %             }
%     %             {2\left((1-\beta)\commweightfromblock[from=b',to=s,chkp=C]{\allvals}-\attsetweighttobediscfromblock[from=b',to=s,val=v,when=t,chkp=C]{\allatts}\right)}
%     %     \\
%     %     &\hspace{5cm} +
%     %     \frac
%     %         {\beta\commweightfromblock[from=b',to=s,chkp=C]{\allvals}}
...
%     &=\frac
%     {\attsetweightfromblock[from=b',to=s,val=v,when=t,chkp=C]{\honatts}}
%     {\commweightfromblock[from=b',to=s,chkp=C]{\honvals}-\attsetweighttobediscfromblock[from=b',to=s,val=v,when=t,chkp=C]{\honatts}}
%     \\
%     &\geq
%     \frac
%     {\attsetweightfromblock[from=b',to=s,val=v,when=t,chkp=C]{\allatts}-
...
%     {\attsetweightfromblock[from=b',to=s,val=v,when=t,chkp=C]{\allatts}-
%     \commweightfromblock[from=b',to=s,chkp=C]{\advvals}}
%     {\commweightfromblock[from=b',to=s,chkp=C]{\allvals} - \commweightfromblock[from=b',to=s,chkp=C]{\advvals}-\attsetweighttobediscfromblock[from=b',to=s,val=v,when=t,chkp=C]{\honatts}}
%     \\
%     % &\geq
%     % \frac
%     % {\attsetweightfromblock[from=b',to=s,val=v,when=t,chkp=C]{\allatts}-
