            ...
            \begin{description}
                ...
                \begin{description}
                    ...
                    \begin{description}
                        ...
                        Also note that $b_c \succ \varforvalattime[val=v,time=\slotstart(s)]{\bconfirmed}$ for this case.
                        Given all this, we conclude $\slot(s + 1) > \firstslot(\epoch(s+1))$ which implies $\epoch(s+1) = \epoch(s)$.
                        ...
                        So, given that $\viewattime[time=\slotstart(s-1),val=v'] \subseteq \viewattime[time=\slotstart(s),val=v']$ and $\viewattime[time=\slotstart(s),val=v] \subseteq \viewattime[time=\slotstart(s+1),val=v]$ and $b_c \succ \varforvalattime[val=v,time=\slotstart(s)]{\bconfirmed}$, the proof for this case is concluded.
                    \end{description}
                \end{description}
            \end{description}
        \end{description}
