...
Let $\attsetfromafterblock[from=b,to=s,when=t,val=v]{\exactatts}$ be the set of validators be the set of validators in $\commfromslot[from=\slot(b)+1, to=s',when=t,val=v]{\allvals}$ that, according to $\viewattime[val=v,time=t]$, have sent a \GHOST vote that \LMDGHOST voted \emph{exactly} $b$, \ie, not for any $b' \succ b$, just exactly for $b$.
...
\begin{lemma}\label{lem:condition-on-h-for-canonical}
    ...
    \begin{enumerate}
        ...
        \frac
            ...
            {\allvals}-\attsetweightfromafterblock[from=\parent(b),to=\slot(t)-1,when=t,val=v,chkp={\gjattime[val=v,time=t]}]{\exactatts}+\boostweight[chkp={\gjattime[val=v,time=t]}]}{2}
        $,
    \end{enumerate}
...
\begin{proof}
    ...
    \begin{description}
        ...
        \begin{description}
            ...
            Due to \FILINV and \FILCUR, the maximum value that such expression can evaluate to corresponds to the weight of the the committees between slot $\slot(b)+1$ and slot $\slot(t)-1$ plus, potentially, the proposer boost weight, \ie, $\commweightfromblock[from={b},to={\slot(t)-1},chkp={\gjattime[time=t,val=v]}]{\allvals} + \boostweight[chkp={\gjattime[val=v,time=t]}]$.
            ...
            \frac
                {\commweightfromblock[from=b,to=\slot(t)-1,chkp={\gjattime[val=v,time=t]}]
                {\allvals}
                -\attsetweightfromafterblock[from=\parent(b),to=\slot(t)-1,when=t,val=v,chkp={\gjattime[val=v,time=t]}]{\exactatts}
            ...
            \begin{align*}
                \weightofset[chkp={\gjattime[time=t,val=v]}]{\ghostvoters[block=b',view={\FIL_\LMDGHOST(\View, t)}]} &< \commweightfromblock[from={b},to={\slot(t)-1},chkp={\gjattime[time=t,val=v]}]{\allvals}-\attsetweightfromafterblock[from=\parent(b),to=\slot(t)-1,when=t,val=v,chkp={\gjattime[val=v,time=t]}]{\exactatts} + \boostweight[chkp={\gjattime[val=v,time=t]}] -  \weightofset[chkp={\gjattime[time=t,val=v]}]{\ghostvoters[block=b_c,view={\FIL_\LMDGHOST(\View, t)}]}\\
                &\leq
                \frac
                {\commweightfromblock[from=b,to=\slot(t)-1,chkp={\gjattime[val=v,time=t]}]
                {\allvals}
