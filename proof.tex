...
\begin{proof}
    ...
    \begin{align*}
        ...
        &=
        \frac
            {\attsetweightfromblock[from={s},to=s'-1,val=v,when=\slotstart(s'),chkp={C'}]{\allatts}}
            {\commweightfromblock[from=b,to=s'-1,chkp={C'}]{\allvals}}
        +
        \frac
            {\attsetweightfromblock[from=b,to=s-1,val=v,when=\slotstart(s'),chkp={C'}]{\allatts}}
            {\commweightfromblock[from=b,to=s'-1,chkp={C'}]{\allvals}}
        &&\alignexpl[\alignexplwidth]{As, $\attsetfromblockunfiltered[from=b,to=s'-1,val=v,when=\slotstart(s')]{\allatts} = \attsetfromblockunfiltered[from=b,to=s-1,val=v,when=\slotstart(s')]{\allatts} \cup \attsetfromblockunfiltered[from=s,to=s'-1,val=v,when=\slotstart(s')]{\allatts}$.}
        \\
        &=
        \frac
            {\attsetweightfromblock[from={s},to=s'-1,val=v,when=\slotstart(s'),chkp={C'}]{\allatts}}
        ...
        &=
        \frac
            {\attsetweightfromblock[from={s},to=s'-1,val=v,when=\slotstart(s'),chkp={C'}]{\allatts} - \attsetweightfromblock[from=b,to=s-1,val=v,when=\slotstart(s'),chkp={C'}]{\slashvals}}
            {\commweightfromblock[from=b,to=s'-1,chkp={C'}]{\allvals}}
        \\
        &+
        \frac
        ...
        \frac
            {\frac{1}{2}\left(\commweightfromblock[from=b,to=s-1,chkp={C'}]{\allvals} + \boostweight[chkp=C']\right) + \beta \commweightfromblock[from=b,to=s-1,chkp={C'}]{\allvals}}
            {\commweightfromblock[from=b,to=s'-1,chkp={C'}]{\allvals}}
        &&\alignexpl[\alignexplwidth]{By the synchrony assumption.}
        \\
        &>
        \frac
        ...
        \frac
            {\frac{1}{2}\left(\commweightfromblock[from=b,to=s-1,chkp={C'}]{\allvals} + \boostweight[chkp=C']\right) + \beta \commweightfromblock[from=b,to=s-1,chkp={C'}]{\allvals}}
            {\commweightfromblock[from=b,to=s'-1,chkp={C'}]{\allvals}}
        &&\alignexpl[\alignexplwidth]{As, $1-b \geq \frac{1}{2}+\beta$ because $\beta \leq \frac{1}{4}$.}
        \\
        &>
        \frac
