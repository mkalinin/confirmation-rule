...
\begin{lemma}\label{lem:beta-less-than-quarter-no-reconfirmation-required}
    If
    \begin{enumerate}
        \item $\firstslot(\epoch(t)) \geq \GST$
        \item $\epoch(\varforvalattime[val=v,time=\slotstartslot{t}]{\bconfirmed}) = \epoch(t)$
        \item $\beta \leq \frac{1}{4}$
    \end{enumerate},
    then, let $s' := \firstslot(\epoch(t)+1)$, $\chkp' := \guattime[val=v,time=\slotstart(s'-1)]$, $b := \varforvalattime[val=v,time=\slotstartslot{t})]{\bconfirmed}$,
    \begin{enumerate}
...
\begin{proof}
    Let $s$ be the lowest slot such that $\varforvalattime[val=v,time=\slotstart(s)]{\bconfirmed} = \varforvalattime[val=v,time=\slotstartslot{t}]{\bconfirmed}$. Due to \Cref{lem:bcand-current-epoch-then-no-first-slot} we know that $s > \firstslot(\epoch(t))$.
    Then due to \Cref{ln:if-is-one-confirmed-second-loop} we have:
    \begin{align*}
        ...
        \frac{S^{s-1, v, \slotstart(s), \chkp}_{b}}{W^{s-1, \chkp}_{b}} > \frac{1}{2}\left(1 + \frac{W^{\chkp}_p}{W^{s-1, \chkp}_b}\right) + \beta - \frac{D^{s-1, v, \slotstart(s), \chkp}_b}{W^{s-1, \chkp}_b},\\
        S^{s-1, v, \slotstart(s), \chkp}_{b} > \frac{1}{2}\left({W^{s-1, \chkp}_b} + W^{\chkp}_p\right) + \beta W^{s-1, \chkp}_b - D^{s-1, v, \slotstart(s), \chkp}_b,\\
        S^{s-1, v, \slotstart(s), \chkp}_{b} > \left(\frac{1}{2} + \beta\right){W^{s-1, \chkp}_b} + \frac{1}{2} W^{\chkp}_p - D^{s-1, v, \slotstart(s), \chkp}_b.
    \end{align*}
    given that $s > \firstslot(\epoch(t))$, $C = \gjattime[val=v,time=\slotstart(s)-1]$ in this case.
    Due to $\chkp \preceq \chkp'$ \MKfn{This requires a proof} and Assumption 1 of the Paper $\weightofset[chkp=\chkp']{W_t} + \weightofset[chkp=\chkp']{D} = \weightofset[chkp=\chkp]{W_t} + \weightofset[chkp=\chkp]{D}$, therefore the following is true:
    \begin{itemize}
        \item $S^{s-1, v, \slotstart(s), \chkp}_{b} \leq S^{s-1, v, \slotstart(s'), \chkp'}_{b}$, because $S^{s-1, v, \slotstart(s)}_{b} \subseteq S^{s-1, v, \slotstart(s')}_{b}$,
        \item $D^{s-1, v, \slotstart(s), \chkp}_{b} \leq D^{s'-1, v, \slotstart(s'), \chkp'}_{b}$, because $D^{s-1, v, \slotstart(s)}_{b} \subseteq D^{s'-1, v, \slotstart(s')}_{b}$,
        \item $W^{s-1,\chkp'}_b \leq W^{s-1,\chkp}_b$,
        \item $W^{\chkp'}_p \leq W^{\chkp}_p$.
    \end{itemize}
    ...
    \begin{align*}
        S^{s-1, v, \slotstart(s'), \chkp'}_{b} > \left(\frac{1}{2} + \beta\right){W^{s-1, \chkp'}_b} + \frac{1}{2} W^{\chkp'}_p - D^{s'-1, v, \slotstart(s'), \chkp'}_b.
    \end{align*}
    Then we proceed with the inequality from the Lemma's statement:
    \begin{align*}
        Q^{s'-1, v, \slotstart(s'), \chkp'}_{b} > \frac{1}{2}\left(1 + \frac{W^{\chkp'}_p}{W^{s'-1, \chkp'}_b}\right) + \beta - \frac{D^{s'-1, v, \slotstart(s'), \chkp'}_b}{W^{s'-1, \chkp'}_b},\\
        \frac{S^{s'-1, v, \slotstart(s'), \chkp'}_{b}}{W^{s'-1, \chkp'}_{b}} > \frac{1}{2}\left(1 + \frac{W^{\chkp'}_p}{W^{s'-1, \chkp'}_b}\right) + \beta - \frac{D^{s'-1, v, \slotstart(s), \chkp'}_b}{W^{s'-1, \chkp'}_b},\\
        S^{s'-1, v, \slotstart(s'), \chkp'}_{b} > \left(\frac{1}{2} + \beta\right){W^{s'-1, \chkp'}_b} + \frac{1}{2} W^{\chkp'}_p - D^{s'-1, v, \slotstart(s'), \chkp'}_b,\\
        S^{s'-1, v, \slotstart(s'), \chkp'}_{s} + S^{s-1, v, \slotstart(s'), \chkp'}_{b} >\\ \left(\frac{1}{2} + \beta\right){W^{s-1, \chkp'}_b} + \frac{1}{2} W^{\chkp'}_p - D^{s'-1, v, \slotstart(s'), \chkp'}_b + \left(\frac{1}{2} + \beta\right){W^{s'-1, \chkp'}_s},\\
    \end{align*}
    given
    \begin{align*}
        S^{s-1, v, \slotstart(s'), \chkp'}_{b} > \left(\frac{1}{2} + \beta\right){W^{s-1, \chkp'}_b} + \frac{1}{2} W^{\chkp'}_p - D^{s'-1, v, \slotstart(s'), \chkp'}_b,
    ...
    \begin{align*}
        S^{s'-1, v, \slotstart(s'), \chkp'}_{s} \geq \left(\frac{1}{2} + \beta\right){W^{s'-1, \chkp'}_s},\\
        ...
        \beta \leq \frac{1}{4}.
    \end{align*}
    Given conditions of the Lemma's statement the proof is concluded.
\end{proof}
...
\begin{lemma}
    ...
    \begin{enumerate}
        ...
        \item $\beta \leq \frac{1}{4}$
    \end{enumerate},
    then, let $s' := \firstslot(\epoch(t)+1)$, $\chkp' := \guattime[val=v,time=\slotstart(s'-1)]$, for $\forall b' \prec \varforvalattime[val=v,time=\slotstartslot{t}]{\bconfirmed}$ such that $\epoch(b) = \epoch(t)-1$,
    \begin{enumerate}
...
\begin{proof}
    Let $b \preceq \varforvalattime[val=v,time=\slotstartslot{t}]{\bconfirmed}$ be the lowest block in the chain of $\varforvalattime[val=v,time=\slotstartslot{t}]{\bconfirmed}$ such that $\epoch(b)=\epoch(t)$.
    Clearly $b = \varforvalattime[val=v,time=\slotstartslot{t'}]{\bconfirmed}$ for some time $t' \leq t$.
    Then due to \Cref{lem:beta-less-than-quarter-no-reconfirmation-required} we have:
    \begin{align*}
        \frac{S^{s'-1, v, \slotstart(s'), \chkp'}_{b}}{W^{s'-1,\chkp'}_b} > \frac{1}{2}\left(1 + \frac{W^{\chkp'}_p}{W^{s'-1, \chkp'}_{b}}\right) + \beta - \frac{D^{s'-1, v, \slotstart(s'), \chkp'}_{b}}{W^{s'-1, \chkp'}_{b}},\\
        S^{s'-1, v, \slotstart(s'), \chkp'}_{b} > \frac{1}{2}\left({W^{s'-1,\chkp'}_b} + {W^{\chkp'}_p}\right) + \beta W^{s'-1,\chkp'}_b - D^{s'-1, v, \slotstart(s'), \chkp'}_{b}.
    \end{align*}
    Given $b$ is the lowest block such that $\epoch(b)=\epoch(t)$ and the fact that $\epoch(b') = \epoch(t)-1$, we can conclude the following:
    \begin{itemize}
        \item $W^{s'-1,\chkp'}_b = W^{s'-1,\chkp'}_{b'} = W^{\chkp'}_t$,
        \item $S^{s'-1, v, \slotstart(s'), \chkp'}_{b'} \geq S^{s'-1, v, \slotstart(s'), \chkp'}_{b}$, because $b' \prec b$ and thus $S^{s'-1, v, \slotstart(s'), \chkp'}_{b} \subset S^{s'-1, v, \slotstart(s'), \chkp'}_{b'}$,
        \item $D^{s'-1, v, \slotstart(s'), \chkp'}_{b'} \geq D^{s'-1, v, \slotstart(s'), \chkp'}_{b}$, because $D^{s'-1, v, \slotstart(s'), \chkp'}_{b} \subset D^{s'-1, v, \slotstart(s'), \chkp'}_{b'}$.
    \end{itemize}

    Given the above we have:
    \begin{align*}
        S^{s'-1, v, \slotstart(s'), \chkp'}_{b'} > \frac{1}{2}\left({W^{s'-1,\chkp'}_{b'}} + {W^{\chkp'}_p}\right) + \beta W^{s'-1,\chkp'}_{b'} - D^{s'-1, v, \slotstart(s'), \chkp'}_{b'},\\
